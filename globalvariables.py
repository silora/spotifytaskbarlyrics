...
## Netease DOES NOT PROVIDED BJORK SONGS!!!!!
THIRD_PARTY_LYRICS_PROVIDERS = ["NetEase", "Musixmatch", "Lrclib"]
...
## Mixed: Uses Spotify API to get the current playing track id, then uses System to get all the rest information. Spotify API is only called on track change. DOES PROVIDE TRACK ID.
